...
| :----------------- | :----- | :------- | :--------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| options            | Object | false    | -                      | Options used when calling addAccount to include { clientId, redirectUri, portalUrl, popup, params }. Can also be fed directly to addAccount function. Note: portalUrl will default to ArcGIS Online, popup will default to false. Params is an object that allows the addition of url params {key: value} to the auth request (Ex: avoid redirects when adding an account with params = {force_login: true} ).[Formatting portalUrl docs](https://developers.arcgis.com/rest/users-groups-and-items/root.htm). Example \_https\*://[`webadaptorhost`].[`domain`].com/[`webadaptorname`]/sharing |

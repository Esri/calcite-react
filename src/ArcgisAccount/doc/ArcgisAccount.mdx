          ...
          <TopNav>
            ...
            <TopNavActionsList style={{ padding: 0 }}>
              <ArcgisAccount
                ...
                onRequestSwitchAccount={() => removeAllAccounts()
                }
...
| :----------------- | :----- | :------- | :--------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| options            | Object | false    | -                      | Options used when calling addAccount to include { clientId, redirectUri, portalUrl, popup }. Can also be fed directly to addAccount function. Note: portalUrl will default to ArcGIS Online, popup will default to false. [Portal Url Format Doc](https://developers.arcgis.com/rest/users-groups-and-items/root.htm). Example _https_://[`webadaptorhost`].[`domain`].com/[`webadaptorname`]/sharing/rest |
...
| getUserThumbnail    | Func   | account: Account Object `Required` | account: Object obtained from accounts list {portal:{},user:{},session:{}, token: String, key: String}                                                                                                                                                                                                               | Returns object with thumbnail url and user avatar string: {url: String \| undefined, letters: String \| '!'}                                                |
| getOrgThumbnail     | Func   | account: Account Object `Required` | account: Object obtained from accounts list {portal:{},user:{},session:{}, token: String, key: String}                                                                                                                                                                                                               | Returns object with thumbnail url and org avatar string: {url: String \| undefined, letters: String \| '!'}                                                 |

...
| options            | Object | false    | -       | Options used when calling addAccount to include { clientId, redirectUri, portalUrl, popup }. Can also be fed directly to addAccount function. Note: portalUrl will default to ArcGIS Online, popup will default to true.                               |

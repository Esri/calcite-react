      ...
      class SearchStory extends React.Component {
        ...
        fetchStates(q) {
          return new Promise((resolve, response) => {
            const url = `https://services.arcgis.com/P3ePLMYs2RVChkJx/ArcGIS/rest/services/USA_States_Generalized/FeatureServer/0/query?where=UPPER(STATE_NAME) LIKE UPPER('${q}%')&outFields=STATE_NAME&returnGeometry=false&orderByFields=STATE_NAME asc&f=json`;
